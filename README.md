...
Drush command that backs up files over FTP from local files, which may be generated by [svn-export](https://github.com/simpledrupalcloud/svn-export) or [git-export](https://github.com/simpledrupalcloud/git-export).
