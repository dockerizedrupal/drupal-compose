...
apache:
  extends:
    file: host.yml
    service: apache
  image: dockerizedrupal/apache-2.4:1.0.9
  hostname: apache
  ports:
    - "80"
    - "443"
...
php:
  extends:
    file: host.yml
    service: php
  image: dockerizedrupal/php-5.5:1.0.5
  hostname: php
  volumes:
...
mailcatcher:
  image: dockerizedrupal/mailcatcher:1.0.2
...
phpmyadmin:
  image: dockerizedrupal/phpmyadmin:1.0.3
  hostname: phpmyadmin
  ports:
    - "80"
    - "443"
...
adminer:
  image: dockerizedrupal/adminer:1.0.4
  hostname: adminer
  ports:
    - "80"
    - "443"
...
memcached:
  image: dockerizedrupal/memcached:1.0.2
  hostname: memcached
  environment:
    - VHOST_PROJECT_NAME=${PROJECT_NAME}
...
memcachephp:
  image: dockerizedrupal/memcachephp:1.0.2
...
php:
  extends:
    file: host.yml
    service: php
  image: dockerizedrupal/php-5.3:1.0.6
  hostname: php
  volumes:
    - ~/.ssh:/home/container/.ssh
  volumes_from:
...
apache:
  extends:
    file: host.yml
    service: apache
  image: dockerizedrupal/apache-2.2:1.0.5
  hostname: apache
  ports:
    - "80"
    - "443"
...
php:
  extends:
    file: host.yml
    service: php
  image: dockerizedrupal/php-5.2:1.0.3
  hostname: php
  volumes:
    - ~/.ssh:/home/container/.ssh
  volumes_from:
